...
weatherApi = 'cc523fe571c72f039b5d67907f1a2518'  # https://openweathermap.org/api
wolframAlphaApi = 'QALVTK-JW28J7RQ9T' # https://products.wolframalpha.com/simple-api/documentation/
    ...
    while 1:
        ...
        if 'time' in query:
            ...
            if x["cod"] != "404":
                ...
                speak(" Temperature of " + str(city_name) + " is " + str(current_temperature) + 'in kelvin unit')
                time.sleep(5)
